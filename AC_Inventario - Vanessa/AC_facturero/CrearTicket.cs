...
namespace AC_facturero
{
    class CrearTicket
    {
        ...
        {
            linea.AppendLine("ARTICULO               |STOCK  |FRACC.  ");
        }
        ...
        public void AgregaArticulo(string articulo, int cant, int fracciones)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 5 && fracciones.ToString().Length <= 8)
            {
                ...
                if (articulo.Length > 23)
                {
                    ...
                    nroEspacios = (7 - fracciones.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    ...
                    for (int longitudTexto = articulo.Length; longitudTexto > 23; longitudTexto -= 23)
                    {
                        if (bandera == false)//si es false o la primera linea en recorrerer, continuar...
                        {
                            ...
                            linea.AppendLine(articulo.Substring(caracterActual, 23) + elemento);
                            bandera = true;//cambiamos su valor a verdadero
                        }
                        else
                            linea.AppendLine(articulo.Substring(caracterActual, 23));//Solo agrega el nombre del articulo

                        caracterActual += 23;//incrementa en 20 el valor de la variable caracterActual
                    }
                ...
                {
                    for (int i = 0; i < (23 - articulo.Length); i++)
                    {
                    ...
                    elemento += espacios + fracciones.ToString();

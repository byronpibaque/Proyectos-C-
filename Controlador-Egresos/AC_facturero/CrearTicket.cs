...
namespace AC_facturero
{
    class CrearTicket
    {
        ...
        {
            linea.AppendLine("ARTICULO       |Ca|Fr|CODIGO       ");
        }
        ...
        public void AgregaArticulo(string articulo, int cant,int fracciones, string codigo)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 2 && fracciones.ToString().Length <= 2 && codigo.Length<=13)
            {
                ...
                if (articulo.Length > 15)
                {
                    ...
                    elemento += espacios + cant.ToString();//agregamos la cantidad con los espacios
                                                           //Colocar la cantidad a la derecha.
                    nroEspacios = (3 - fracciones.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";//Generamos los espacios necesarios para alinear a la derecha
                    }
                    elemento += espacios + fracciones.ToString();//agregamos la cantidad con los espacios

                    nroEspacios = (13 - codigo.ToString().Length);
                    espacios = "  ";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";//Generamos los espacios necesarios para alinear a la derecha
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (2 - cant.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (3 - fracciones.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";

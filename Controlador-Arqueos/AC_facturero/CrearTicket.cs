...
namespace AC_facturero
{
    class CrearTicket
    {
        ...
        {
            linea.AppendLine("ARTICULO        |CANT|CODIGO       ");
        }
        ...
        public void AgregaArticulo(string articulo, int cant, string codigo)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 4 && codigo.Length<=13)
            {
                ...
                {
                    for (int i = 0; i < (17 - articulo.Length); i++)
                    {
